...
!function (t, e) {
    ...
    function be(t, e) {
        const {canvas: i, currentDevicePixelRatio: n} = e, o = ge(i), s = "border-box" === o.boxSizing,
            a = xe(o, "padding"), r = xe(o, "border", "width"), {x: l, y: c, box: h} = function (t, e) {
    ...
    function ye(t, e, i, n) {
        const o = ge(t), s = xe(o, "margin"), a = fe(o.maxWidth, t, "clientWidth") || vt,
            r = fe(o.maxHeight, t, "clientHeight") || vt, l = function (t, e, i) {
                let n, o;
                if (void 0 === e || void 0 === i) {
                    const s = ue(t);
                    if (s) {
                        const t = s.getBoundingClientRect(), a = ge(s), r = xe(a, "border", "width"), l = xe(a, "padding");
        ...
        if ("content-box" === o.boxSizing) {
            const t = xe(o, "border", "width"), e = xe(o, "padding");
    ...
    function Me(t, e) {
        const i = pe(t, e), n = i && i.match(/^(\d+)(\.\d+)?px$/);
        return n ? +n[1] : void 0
    }
    ...
    function Oe(t, e, i, n) {
        const o = ke(e, t), s = [], a = i.axis, r = "x" === a ? "inXRange" : "inYRange";
        let l = !1;
        return function (t, e) {
    ...
    var Te = {
        modes: {
            index(t, e, i, n) {
                const o = ke(e, t), s = i.axis || "x", a = i.intersect ? De(t, o, s, n) : Ce(t, o, s, !1, n), r = [];
    ...
    function Xe(t, e, i) {
        ...
        const s = Math.max(0, e.outerWidth - Ye(o, t, "left", "right")),
            a = Math.max(0, e.outerHeight - Ye(o, t, "top", "bottom")), r = s !== t.w, l = a !== t.h;
    ...
    var Ze = {
        addBox(t, e) {
            ...
            if (!t) return;
            const o = Fe(t.options.layout.padding), s = Math.max(e - o.width, 0), a = Math.max(i - o.height, 0),
                r = function (t) {
                    const e = function (t) {
                            const e = [];
                            let i, n, o;
                            ...
                            return e
                        }(t), i = $e(e.filter((t => t.box.fullSize)), !0), n = $e(He(e, "left"), !0),
                        o = $e(He(e, "right")), s = $e(He(e, "top"), !0), a = $e(He(e, "bottom")), r = je(e, "x"),
                        l = je(e, "y");
                    return {
                        fullSize: i,
    ...
    function oi(t, e, i) {
        const n = t.canvas, o = n && ue(n) || n, s = new MutationObserver((t => {
            const e = ue(o);
            t.forEach((t => {
    ...
    function di(t, i, n) {
        const o = t.canvas, s = e((e => {
            null !== t.ctx && n(function (t, e) {
                const i = ti[t.type] || t.type, {x: n, y: o} = be(t, e);
    ...
    class ui extends Qe {
        ...
        addEventListener(t, e, i) {
            ...
            const n = t.$proxies || (t.$proxies = {}), o = {attach: oi, detach: si, resize: ci}[e] || di;
            n[e] = o(t, e, i)
        }
    ...
    const gi = t => 0 === t || 1 === t, pi = (t, e, i) => -Math.pow(2, 10 * (t -= 1)) * Math.sin((t - e) * _t / i),
        mi = (t, e, i) => Math.pow(2, -10 * t) * Math.sin((t - e) * _t / i) + 1, xi = {
            linear: t => t,
            easeInQuad: t => t * t,
            easeOutQuad: t => -t * (t - 2),
            ...
            boolean: (t, e, i) => i > .5 ? e : t, color(t, e, i) {
                const n = W(t || bi), o = n.valid && W(e || bi);
    ...
    const Li = t => "reset" === t || "none" === t, Ri = (t, e) => e ? t : Object.assign({}, t);
    ...
    class Ei {
        ...
        linkScales() {
            const t = this, e = t.chart, i = t._cachedMeta, n = t.getDataset(),
                o = (t, e, i, n) => "x" === t ? e : "r" === t ? n : i, s = i.xAxisID = K(n.xAxisID, Ti(e, "x")),
                a = i.yAxisID = K(n.yAxisID, Ti(e, "y")), r = i.rAxisID = K(n.rAxisID, Ti(e, "r")), l = i.indexAxis,
        ...
        getMinMax(t, e) {
            const i = this, n = i._cachedMeta, o = n._parsed, s = n._sorted && t === n.iScale, a = o.length,
                r = i._getOtherScale(t), l = e && n._stacked && {keys: ki(i.chart, !0), values: null},
    ...
    function Ui(t, e) {
        ...
        const i = Be(t.font, e), n = Fe(t.padding);
    ...
    class qi extends zi {
        ...
        _computeGridLineItems(t) {
            const e = this, i = e.axis, n = e.chart, o = e.options, {grid: s, position: a} = o, r = s.offset,
                l = e.isHorizontal(), c = e.ticks.length + (r ? 1 : 0), h = Yi(s), d = [],
        ...
        _computeLabelItems(t) {
            const e = this, i = e.axis, n = e.options, {position: o, ticks: s} = n, a = e.isHorizontal(),
                r = e.ticks, {align: l, crossAlign: c, padding: h, mirror: d} = s, u = Yi(n.grid), f = u + h,
            ...
            for (x = 0, b = r.length; x < b; ++x) {
                ...
                if (a ? (v = k, C = "top" === o ? "near" === c || 0 !== p ? -D * P + P / 2 : "center" === c ? -T.highest.height / 2 - i * P + P : -T.highest.height + P / 2 : "near" === c || 0 !== p ? P / 2 : "center" === c ? T.highest.height / 2 - i * P : T.highest.height - D * P, d && (C *= -1)) : (w = k, C = (1 - D) * P / 2), t.showLabelBackdrop) {
                    const e = Fe(t.backdropPadding), i = T.heights[x], n = T.widths[x];
        ...
        drawTitle() {
            ...
            if (!i.display) return;
            const s = Be(i.font), a = Fe(i.padding), r = i.align;
    ...
    const Qi = (t, e) => t ? t + ct(e) : e, Ji = (t, e) => U(e) && "adapters" !== t;
    ...
    function sn(t, e, i, n) {
        const o = e._rootScopes, s = en(e._fallback, i, n), a = [...t, ...o], r = new Set;
        r.add(n);
        let l = an(r, a, i, s || i);
    ...
    const cn = Number.EPSILON || 1e-14, hn = (t, e) => e < t.length && !t[e].skip && t[e],
        dn = t => "x" === t ? "y" : "x";
    ...
    function fn(t, e = "x") {
        const i = dn(e), n = t.length, o = Array(n).fill(0), s = Array(n);
        let a, r, l, c = hn(t, 0);
    ...
    function bn(t, e, i, n) {
        const o = {x: t.cp2x, y: t.cp2y}, s = {x: e.cp1x, y: e.cp1y}, a = mn(t, o, i), r = mn(o, s, i), l = mn(s, e, i),
            c = mn(a, r, i), h = mn(r, l, i);
        return mn(c, h, i)
    }
    ...
    function kn(t, e, i) {
        ...
        const {property: n, start: o, end: s} = i, a = e.length, {
            ...
            between: l,
            normalize: c
        } = wn(n), {start: h, end: d, loop: u, style: f} = function (t, e, i) {
    ...
    function Dn(t, e, i) {
        return i && i.setContext && e ? function (t, e, i) {
            ...
            for (const r of t) {
                ...
                for (a = s + 1; a <= r.end; a++) {
                    const h = e[a % n];
                    l = Cn(i.setContext({type: "segment", p0: c, p1: h})), On(l, t) && (o.push({
                        start: s,
                        end: a - 1,
                        loop: r.loop,
                        style: t
    ...
    class Rn {
        ...
        _createDescriptors(t, e) {
            const i = t && t.config, n = K(i.options && i.options.plugins, {}), o = function (t) {
                const e = [], i = Object.keys(Ln.plugins.items);
    ...
    function Bn(t) {
        ...
        e.plugins = K(e.plugins, {}), e.scales = function (t, e) {
            const i = ft[t.type] || {scales: {}}, n = e.scales || {}, o = In(t.type, e), s = Object.create(null),
                a = Object.create(null);
            return Object.keys(n).forEach((t => {
                const e = n[t], r = Fn(t, e), l = function (t, e) {
                    return t === e ? "_index_" : "_value_"
                }(r, o), c = i.scales || {};
                s[r] = s[r] || t, a[t] = st(Object.create(null), [{axis: r}, e, c[r], c[l]])
            })), t.data.datasets.forEach((i => {
                const o = i.type || t.type, r = i.indexAxis || In(o, e), l = (ft[o] || {}).scales || {};
    ...
    class $n {
        ...
        resolveNamedOptions(t, e, i, n = [""]) {
            const o = {$shared: !0}, {resolver: s, subPrefixes: a} = Yn(this._resolverCache, t, n);
            let r = s;
            if (function (t, e) {
    ...
    class eo {
        ...
        buildOrUpdateScales() {
            ...
            i && (s = s.concat(Object.keys(i).map((t => {
                const e = i[t], n = Fn(t, e), o = "r" === n, s = "x" === n;
                return {
                    options: e,
                ...
                const s = i.options, a = s.id, r = Fn(a, s), l = K(s.type, i.dtype);
        ...
        buildOrUpdateControllers() {
            ...
            for (t._removeUnreferencedMetasets(), n = 0, o = i.length; n < o; n++) {
                ...
                if (s.type && s.type !== a && (t._destroyDatasetMeta(n), s = t.getDatasetMeta(n)), s.type = a, s.indexAxis = o.indexAxis || In(a, t.options), s.order = o.order || 0, s.index = n, s.label = "" + o.label, s.visible = t.isDatasetVisible(n), s.controller) s.controller.updateIndex(n), s.controller.linkScales(); else {
                    const i = Ln.getController(a), {datasetElementType: o, dataElementType: r} = xt.datasets[a];
    ...
    const io = () => J(eo.instances, (t => t._plugins.invalidate())), no = !0;
    ...
    class uo extends Ei {
        ...
        updateElements(t, e, i, n) {
            ...
            for (let h = e; h < e + i; h++) {
                const e = o.getParsed(h), i = s || $(e[a.axis]) ? {base: r, head: r} : o._calculateBarValuePixels(h),
                    f = o._calculateBarIndexPixels(h, c), g = (e._stacks || {})[a.axis], p = {
                        horizontal: l,
                        base: i.base,
        ...
        _calculateBarValuePixels(t) {
            const e = this, {vScale: i, _stacked: n} = e._cachedMeta, {base: o, minBarLength: s} = e.options,
                a = e.getParsed(t), r = a._custom, l = ho(r);
    ...
    class go extends Ei {
        ...
        getLabelAndValue(t) {
            const e = this._cachedMeta, i = this.chart, n = i.data.labels || [], o = Fi(e._parsed[t], i.options.locale);
    ...
    po.id = "line", po.defaults = {
        ...
        showLine: !0,
        spanGaps: !1
    }, po.overrides = {scales: {_index_: {type: "category"}, _value_: {type: "linear"}}};
    ...
    _o.id = "scatter", _o.defaults = {showLine: !1, fill: !1}, _o.overrides = {
    ...
    function ko(t, e, i, n, o) {
        ...
        const g = (f - Math.max(.001, f * h - i / bt) / h) / 2, p = r + g + u, m = o - g - u, {
                ...
                innerStart: _,
                innerEnd: y
            } = wo(e, d, h, m - p), v = h - x, w = h - b, M = p + x / v, k = m - b / w, S = d + _, P = d + y, D = p + _ / S,
            C = m - y / P;
    ...
    function To(t, e, i, n) {
        const {points: o, options: s} = e, {count: a, start: r, loop: l, ilen: c} = Oo(o, i, n), h = function (t) {
    ...
    function Ao(t, e, i, n) {
        const o = e.points, {count: s, start: a, ilen: r} = Oo(o, i, n), {move: l = !0, reverse: c} = n || {};
    ...
    function Eo(t, e, i, n) {
        Ro && 1 === e.segments.length ? function (t, e, i, n) {
            ...
            const {segments: o, options: s} = e, a = Lo(e);
    ...
    class zo extends zi {
        ...
        interpolate(t, e) {
            const i = this, n = i.options, o = t[e], s = i.points, a = Sn(i, {property: e, start: o, end: o});
            if (!a.length) return;
        ...
        path(t, e, i) {
            const n = this, o = n.segments, s = Lo(n);
            let a = n._loop;
    ...
    function jo(t) {
        const e = Bo(t), i = e.right - e.left, n = e.bottom - e.top, o = function (t, e, i) {
            const n = t.options.borderWidth, o = Vo(t), s = ze(n);
            return {
            ...
            const {enableBorderRadius: n} = t.getProps(["enableBorderRadius"]), o = t.options.borderRadius, s = Ie(o),
                a = Math.min(e, i), r = Vo(t), l = n || U(o);
            return {
    ...
    function $o(t, e, i, n) {
        const o = null === e, s = null === i, a = t && !(o && s) && Bo(t, n);
    ...
    class Uo extends zi {
        ...
        draw(t) {
            const e = this.options, {inner: i, outer: n} = jo(this),
    ...
    function ns(t, e, i) {
        ...
        for (let o = 0; o < i.length; o++) {
            const s = i[o], {first: a, last: r, point: l} = os(s, e, "x");
    ...
    function us(t, e) {
        const {line: i, target: n, property: o, color: s, scale: a} = e, r = function (t, e, i) {
            ...
            for (const t of n) {
                ...
                const c = Sn(e, l);
                for (const e of c) {
                    const n = ls(i, s[e.start], s[e.end], e.loop), r = kn(t, o, n);
    ...
    class ms extends zi {
        ...
        fit() {
            ...
            const n = e.labels, o = Be(n.font), s = o.size, a = t._computeTitleHeight(), {
                boxWidth: r,
                itemHeight: l
            } = ps(n, s);
            let c, h;
        ...
        _draw() {
            const t = this, {options: e, columnSizes: i, lineWidths: n, ctx: a} = t, {align: r, labels: l} = e,
                c = xt.color, h = _n(e.rtl, t.left, t.width), d = Be(l.font), {color: u, padding: f} = l, g = d.size,
                p = g / 2;
            let m;
            t.drawTitle(), a.textAlign = h.textAlign("left"), a.textBaseline = "middle", a.lineWidth = .5, a.font = d.string;
            const {boxWidth: x, boxHeight: b, itemHeight: _} = ps(l, g), y = t.isHorizontal(),
        ...
        drawTitle() {
            const t = this, e = t.options, i = e.title, s = Be(i.font), a = Fe(i.padding);
            if (!i.display) return;
            const r = _n(e.rtl, t.left, t.width), l = t.ctx, c = i.position, h = s.size / 2, d = a.top + h;
        ...
        _computeTitleHeight() {
            const t = this.options.title, e = Be(t.font), i = Fe(t.padding);
            ...
            labels: {
                color: t => t.chart.options.color, boxWidth: 40, padding: 10, generateLabels(t) {
                    ...
                    return t._getSortedDatasetMetas().map((t => {
                        const a = t.controller.getStyle(i ? 0 : void 0), r = Fe(a.borderWidth);
                        return {
    ...
    class bs extends zi {
        ...
        draw() {
            ...
            if (!i.display) return;
            const o = Be(i.font), s = o.lineHeight / 2 + t._padding.top, {
                titleX: a,
                titleY: r,
                maxWidth: l,
                rotation: c
    ...
    function Ps(t, e) {
        const i = t._chart.ctx, {body: n, footer: o, title: s} = t, {boxWidth: a, boxHeight: r} = e, l = Be(e.bodyFont),
            c = Be(e.titleFont), h = Be(e.footerFont), d = s.length, u = o.length, f = n.length, g = Fe(e.padding);
    ...
    class Rs extends zi {
        ...
        _resolveAnimations() {
            ...
            const i = t._chart, n = t.options.setContext(t.getContext()),
                o = n.enabled && i.options.animation && n.animations, s = new wi(t._chart, o);
        ...
        getBody(t, e) {
            ...
            return J(t, (t => {
                const e = {before: [], lines: [], after: []}, s = Ls(n, t);
        ...
        update(t, e) {
            ...
            if (o.length) {
                ...
                const e = i._size = Ps(i, n), r = Object.assign({}, t, e), l = Cs(i._chart, n, r),
                    c = Os(n, r, l, i._chart);
        ...
        _drawColorBox(t, e, i, n, o) {
            const s = this, a = s.labelColors[i], r = s.labelPointStyles[i], {boxHeight: l, boxWidth: c} = o,
                h = Be(o.bodyFont), d = Ts(s, "left", o), u = n.x(d), f = l < h.lineHeight ? (h.lineHeight - l) / 2 : 0,
                g = e.y + f;
            if (o.usePointStyle) {
        ...
        drawBody(t, e, i) {
            ...
            const f = _n(i.rtl, n.x, n.width), g = function (i) {
        ...
        _updateAnimationTarget(t) {
            ...
            if (o || s) {
                ...
                if (!n) return;
                const a = e._size = Ps(e, t), r = Object.assign({}, n, e._size), l = Cs(i, t, r), c = Os(t, r, l, i);
        ...
        _positionChanged(t, e) {
            const {caretX: i, caretY: n, options: o} = this, s = ws[o.position].call(this, t, e);
    ...
    function Ys(t) {
        ...
        for (let c = 0; c < s; c++) {
            ...
            o[c] = s.padding;
            const h = t.getPointPosition(c, t.drawingArea + o[c]), d = Be(s.font),
                u = (a = t.ctx, r = d, l = Y(l = t._pointLabels[c]) ? l : [l], {
                    w: Ut(a, r.string, l),
                    h: l.length * r.lineHeight
                });
            n[c] = u;
            const f = t.getIndexAngle(c), g = zt(f), p = $s(g, h.x, u.w, 0, 180), m = $s(g, h.y, u.h, 90, 270);
        ...
        t._setReductions(t.drawingArea, e, i), t._pointLabelItems = function (t, e, i) {
            const n = [], o = t.getLabels().length, s = t.options, a = js(s),
                r = t.getDistanceFromCenterForValue(s.ticks.reverse ? t.min : t.max);
            for (let s = 0; s < o; s++) {
                const o = 0 === s ? a / 2 : 0, l = t.getPointPosition(s, r + o + i[s]), c = zt(t.getIndexAngle(s)),
                    h = e[s], d = qs(l.y, h.h, c), u = Us(c), f = Xs(l.x, h.w, u);
    ...
    class Zs extends Vs {
        ...
        drawGrid() {
            ...
            if (i.pointLabels.display && function (t, e) {
                ...
                for (let o = e - 1; o >= 0; o--) {
                    const e = n.setContext(t.getContext(o)), s = Be(e.font), {
                        x: a,
                        y: r,
                        textAlign: l,
                        left: c,
        ...
        drawLabels() {
            ...
            e.save(), e.translate(t.xCenter, t.yCenter), e.rotate(o), e.textAlign = "center", e.textBaseline = "middle", t.ticks.forEach(((o, r) => {
                ...
                const l = n.setContext(t.getContext(r)), c = Be(l.font);
    ...
    function ia(t, e, i, n) {
        ...
        for (let s = Js.indexOf(t); s < o - 1; ++s) {
            const t = Qs[Js[s]], o = t.steps ? t.steps : Number.MAX_SAFE_INTEGER;
    ...
    class sa extends qi {
        ...
        init(t, e) {
            const i = t.time || (t.time = {}), n = this._adapter = new ao._date(t.adapters.date);
        ...
        _generate() {
            const t = this, e = t._adapter, i = t.min, n = t.max, o = t.options, s = o.time,
                a = s.unit || ia(s.minUnit, i, n, t._getLabelCapacity(i)), r = K(s.stepSize, 1),
        ...
        _getLabelCapacity(t) {
            const e = this, i = e.options.time, n = i.displayFormats, o = n[i.unit] || n.millisecond,
                s = e._tickFormatFunction(t, 0, oa(e, [t], e._majorUnit), o), a = e._getLabelSize(s),
